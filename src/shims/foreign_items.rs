...
use crate::mirch::{free_allocations, insert_init_mask, type_pages_at, PageState, PageTable, TypedKind};
use crate::*;
        ...
        match link_name.as_str() {
            ...
            "kern_miri_zero" => {
                ...
                for i in 0..count {
                    ...
                    let _ = mask_allocation.get_bytes_unchecked_for_overwrite_ptr(this, (0..4096).into());
                }
            }
